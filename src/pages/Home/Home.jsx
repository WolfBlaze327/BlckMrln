          ...
          <div className="row">
            <div className="col-md-12">
              ...
              <div className="container-btn">
                <a className="button" href="/Programs">Enroll Now!</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="third-section">
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6">
            <video autoPlay loop muted plays-inline className="vid2" style={{width: "100%"}}><source src="https://files.learnpac.uk/Email%20signature%20test%20(VA)/Images/LifeSaving.mp4" type="video/mp4"/></video>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="fourth-section">
        <div className="container">
          <div className="row">
            ...
            <div class="col-md-6">
              <video autoPlay loop muted plays-inline className="vid2" style={{width: "100%"}}><source src="https://files.learnpac.uk/Email%20signature%20test%20(VA)/Images/BenefitsKids.mp4" type="video/mp4"/></video>
            </div>
          </div>
        </div>
      </div>
